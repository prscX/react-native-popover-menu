...
export default class App extends Component<{}> {
  ...
  _onPress = ref => {
    ...
    let paste = (
      <Icon name="paste" size={30} color="#000000" family={'FontAwesome'} />
    );
    let share = (
      <Icon name="share" size={30} color="#000000" family={'FontAwesome'} />
    );
    ...
    if (Platform.OS === 'android') {
      popover = (
        <RNPopover
          ...
          reference={this.ref}
          onDone={(mainMenuSelection, subMenuSelection) => {
            console.log(
              'selection: ' + mainMenuSelection + ', ' + subMenuSelection,
            );
          }}>
